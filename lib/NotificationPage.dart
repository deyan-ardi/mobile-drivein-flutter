  ...
  return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(-17.5, 832.5, 432.0, 1.0),
            size: Size(414.0, 896.0),
            pinLeft: true,
            pinRight: true,
            pinBottom: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(-8.5, 366.5, 432.0, 1.0),
            size: Size(414.0, 896.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(-8.5, 474.5, 432.0, 1.0),
            size: Size(414.0, 896.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(-8.5, 554.5, 432.0, 1.0),
            size: Size(414.0, 896.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(59.0, 394.0, 337.0, 54.0),
            size: Size(414.0, 896.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
            child: Text(
              'YURADRIVE have a special promo for\nyou',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 18,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(59.0, 482.0, 341.0, 54.0),
            size: Size(414.0, 896.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
            child: Text(
              'CAHYA PRIVATE  MENGEMUDI have a\nspecial promo for you',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 18,
                color: const Color(0xff655757),
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(8.0, 292.0, 51.0, 51.0),
            size: Size(414.0, 896.0),
            pinLeft: true,
            fixedWidth: true,
            fixedHeight: true,
              ...
              children: <Widget>[
                Pinned.fromSize(
                  ...
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(-3.1, -1.0, 53.4, 80.1),
                        size: Size(60.0, 80.0),
                        pinLeft: true,
                        pinRight: true,
                        pinTop: true,
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image:
                                  const AssetImage('assets/images/img25.png'),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(0.0, 0.0, 51.0, 50.0),
                        size: Size(51.0, 51.0),
                        pinLeft: true,
                        pinRight: true,
                        pinTop: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(63.0, 294.0, 282.0, 54.0),
            size: Size(414.0, 896.0),
            fixedWidth: true,
            fixedHeight: true,
            child: Text(
              'Missel, Remember!\nYou have schedule on Monday ',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 18,
                color: const Color(0xff655757),
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(9.0, 494.0, 38.0, 38.0),
            size: Size(414.0, 896.0),
            pinLeft: true,
            fixedWidth: true,
            fixedHeight: true,
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/img12.png'),
                  fit: BoxFit.cover,
                ),
                border: Border.all(width: 1.0, color: const Color(0x00000000)),
              ),
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(0.7, 390.3, 61.0, 58.0),
            size: Size(414.0, 896.0),
            pinLeft: true,
            fixedWidth: true,
            fixedHeight: true,
...
const String _svg_4oi0f5 =
    '<svg viewBox="0.0 0.0 414.0 216.0" ><path  d="M 0 0 L 414 0 L 414 186 C 414 202.5685424804688 400.5685424804688 216 384 216 L 30 216 C 13.43145751953125 216 0 202.5685424804688 0 186 L 0 0 Z" fill="#254da1" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_cskork =
    '<svg viewBox="-8.5 366.5 432.0 1.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(-8.5, 366.5)" d="M 0 0 L 432 0" fill="none" stroke="#e4e4e4" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
const String _svg_qkdzhc =
    '<svg viewBox="-8.5 474.5 432.0 1.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(-8.5, 474.5)" d="M 0 0 L 432 0" fill="none" stroke="#e4e4e4" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
const String _svg_yw4tls =
    '<svg viewBox="-8.5 554.5 432.0 1.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(-8.5, 554.5)" d="M 0 0 L 432 0" fill="none" stroke="#e4e4e4" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
