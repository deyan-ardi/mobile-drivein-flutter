    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(66.0, 354.0, 300.5, 242.5),
            size: Size(414.0, 896.0),
            pinRight: true,
            fixedWidth: true,
            fixedHeight: true,
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.5, 44.5, 300.0, 1.0),
                  size: Size(300.5, 242.5),
                  pinLeft: true,
                  pinRight: true,
                  pinTop: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.5, 110.5, 300.0, 1.0),
                  size: Size(300.5, 242.5),
                  pinLeft: true,
                  pinRight: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.5, 179.5, 300.0, 1.0),
                  size: Size(300.5, 242.5),
                  pinLeft: true,
                  pinRight: true,
                  fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(124.0, 133.0, 167.0, 167.0),
            size: Size(414.0, 896.0),
            pinTop: true,
            fixedWidth: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(178.0, 72.0, 68.0, 40.0),
            size: Size(414.0, 896.0),
            pinTop: true,
            fixedWidth: true,
            fixedHeight: true,
...
const String _svg_7bb6nf =
    '<svg viewBox="48.5 572.5 300.0 1.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(48.5, 572.5)" d="M 0 1 L 300 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
const String _svg_uralyj =
    '<svg viewBox="48.5 634.5 300.0 1.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(48.5, 634.5)" d="M 0 1 L 300 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
