  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromSize(
            bounds: Rect.fromLTWH(32.0, 234.0, 351.0, 372.0),
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(64.0, 281.0, 286.0, 286.0),
            size: Size(414.0, 896.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(32.0, 709.0, 190.0, 101.0),
            size: Size(414.0, 896.0),
            pinLeft: true,
            pinBottom: true,
            fixedWidth: true,
          ...
          Pinned.fromSize(
            ...
            child: Text.rich(
              TextSpan(
                ...
                children: [
                  TextSpan(
                    text: 'Give this QR Code to Cashier to ',
                  ),
                  TextSpan(
                    text: 'Pay',
                    style: TextStyle(
